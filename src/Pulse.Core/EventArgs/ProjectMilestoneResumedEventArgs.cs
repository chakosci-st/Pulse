...
{
    public class ProjectMilestoneResumedEventArgs : BaseEventArgs
    {
        public string SysId;
        ...
        public ProjectMilestoneResumedEventArgs(string sysid, Status previousStatus, string continuedBy, DateTime continuedDate, string reason)
        {
