...
$(document).ready(function () {
    var table = $('#categoriesTable').DataTable({
        ...
        "initComplete": function () {
            ...
            $tableContainer.find('.dt-paging').appendTo('.card-tools-categoriesTable-pagination');
            $tableContainer.find('.dt-search').appendTo('.card-tools-categoriesTable-filter');
            $tableContainer.find('.dt-length').appendTo('.card-tools-categoriesTable-length');
            $tableContainer.find('.dt-info').appendTo('.card-tools-categoriesTable-size');
    ...
    <div class="card request-card mb-2">
        ...
        <div class="d-lg-flex align-items-center">
          ...
          <div class="flex-fill pr-lg-3">
            ...
            <div class="small text-muted mb-1">
              Code: <strong>${data.categoryCode}</strong>
            </div>
            <div class="small text-muted mb-1">
     ...
     <div class="flex-fill pr-lg-3">
             <div class="small text-muted mb-1">
              Ongoing Projects: <strong>${data.activeProjectsCount}</strong>
            </div>
            <div class="small text-muted mb-1">
              Ongoing Tasks: <strong>${data.activeTasksCount}</strong>
            </div>
            <div class="small text-muted mb-1">
...
<a title="Display" href="/templates/categories/display/${data.categoryCode}"
        class="btn btn-outline-secondary rounded-circle d-inline-flex align-items-center justify-content-center p-0"
        style="width: 40px; height: 40px;">
  <i class="bi bi-eye"></i>
</a>
<a title="Config" href="/templates/categories/edit/${data.categoryCode}"
