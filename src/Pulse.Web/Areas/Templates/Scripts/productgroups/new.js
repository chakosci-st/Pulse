...
$(document).ready(function () {
    ...
    $('#productgroupForm').validate({
        ...
        submitHandler: function (form) {
            ...
            // Collect productGroup data (example)
            var productGroup = {
                ProductGroupCode: $('#Code').val(),
                ProductGroupName: $('#Name').val(),
                ProductGroupDescription: $('#Description').val(),
                IsActive: 1
            };
            ...
            $.ajax({
                ...
                success: function () {
                    ...
                    toastr.success('Product Group created successfully!')
                    ClearField();
                },
                error: function (xhr) {
                    if (xhr.status === 404) {
                        toastr.error('Product Group code does not exist!');
