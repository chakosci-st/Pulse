...
// Function to fetch all productgroups by paging through the API
...
// Usage example: fetch all productgroups and loop through them
            ...
            <div class="widget-user-header text-white" >
                <div class="  my-5 mx-3">
                    <div   style="text-shadow: 2px 2px 4px #000000;">
                        <h1>${row.productGroupName} <br /> 
      <h3>${row.productGroupCode}</h3>
                        </h1>
                    </div>
                </div>
            </div>
...
`
        ...
        console.log("Fetched " + rows.length + " productgroups in total.");
    });
});
