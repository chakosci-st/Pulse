...
// Function to fetch all maturitylevels by paging through the API
...
// Usage example: fetch all maturitylevels and loop through them
...
`
        ...
        console.log("Fetched " + rows.length + " maturitylevels in total.");
    });
});
