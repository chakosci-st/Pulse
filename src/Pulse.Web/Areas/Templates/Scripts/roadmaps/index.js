...
$(document).ready(function () {
    var table = $('#roadmapsTable').DataTable({
        "processing": true, "responsive": true,
        "serverSide": true,
        "ajax": {
            "url": getApiRootPath() + "/api/roadmaps/datatables",
            "type": "POST",
        ...
        "initComplete": function () {
            ...
            $tableContainer.find('.dt-paging').appendTo('.card-tools-roadmapsTable-pagination');
            $tableContainer.find('.dt-search').appendTo('.card-tools-roadmapsTable-filter');
            $tableContainer.find('.dt-length').appendTo('.card-tools-roadmapsTable-length');
            $tableContainer.find('.dt-info').appendTo('.card-tools-roadmapsTable-size');
          ...
          <div class="flex-fill pr-lg-3">
            <div class="d-flex flex-wrap align-items-center mb-1">
              ${status}
                ...
                <strong>${data.roadmapName}</strong> 
