...
// Function to fetch all productdivisions by paging through the API
...
// Usage example: fetch all productdivisions and loop through them
            ...
            <div class="widget-user-header text-white" >
                <div class="  my-5 mx-3">
                    <div   style="text-shadow: 2px 2px 4px #000000;">
                        <h1>${row.productDivisionName} <br /> 
      <h3>${row.productDivisionCode}</h3>
                        </h1>
                    </div>
                </div>
            </div>
...
`
        ...
        console.log("Fetched " + rows.length + " productdivisions in total.");
    });
});
