...
$(document).ready(function () {
 ...
 <!-- Control Button -->
    <a href='${appPath}/Operations/plants/configure/${plant.plantCode}' class="btn btn-light btn-sm position-absolute top-0 end-0 m-2" data-tippy-content="Configure" title="Configure">
