...
function setStickyGuideWidth() {
    const sticky = document.querySelector('.help-sidebar-sticky');
    const column = document.querySelector('.help-sidebar-column');
    ...
    if (window.innerWidth >= 992) {
        sticky.style.width = (column.offsetWidth - 20) + 'px';
        return;
    }
...
window.addEventListener('DOMContentLoaded', setStickyGuideWidth);
window.addEventListener('resize', setStickyGuideWidth);
