...
// Function to fetch a single page of modules
...
// Function to fetch all modules by paging through the API
...
// Usage example: fetch all modules and loop through them
$(document).ready(function () {
            ...
            <div class="widget-user-header text-white">
                <div class="  my-5 mx-3">
                    <div   style="text-shadow: 2px 2px 4px #000000;">
                        <h1>${row.moduleName} <br />
                              <h3>${row.moduleCode}</h3>
                        </h1>
                    </div>
                </div>
            </div>
    ...
    <!--end::Col-->
`
            $('#containerAdd').before(moduleHTML);
        ...
        console.log("Fetched " + rows.length + " modules in total.");
    });
});
