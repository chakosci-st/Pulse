...
$(document).ready(function () {
    var table = $('#modulesTable').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": getApiRootPath() + "/api/modules/datatables",
            "type": "POST",
        ...
        "initComplete": function () {
            ...
            $tableContainer.find('.dt-paging').appendTo('.card-tools-modulesTable-pagination');
            $tableContainer.find('.dt-search').appendTo('.card-tools-modulesTable-filter');
            $tableContainer.find('.dt-length').appendTo('.card-tools-modulesTable-length');
            $tableContainer.find('.dt-info').appendTo('.card-tools-modulesTable-size');
...
<a title="Display" href="/admin/modules/display/${data.moduleCode}"
                class="btn btn-outline-secondary rounded-circle d-inline-flex align-items-center justify-content-center p-0"
                style="width: 40px; height: 40px;">
    <i class="bi bi-eye"></i>
</a>
<a title="Config"  href="/admin/modules/edit/${data.moduleCode}"
