...
// Function to fetch a single page of usergroups
...
// Function to fetch all usergroups by paging through the API
...
// Usage example: fetch all usergroups and loop through them
$(document).ready(function () {
    ...
    <!--end::Col-->
`
            $('#containerAdd').before(usergroupHTML);
        ...
        console.log("Fetched " + rows.length + " usergroups in total.");
    });
});
