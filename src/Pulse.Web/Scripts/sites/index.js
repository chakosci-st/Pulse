...
$(document).ready(function () {
 ...
 <!-- Control Button -->
    <a href='${appPath}/sites/plants/Overview?code=${plant.plantCode}' class="btn btn-light btn-sm position-absolute top-0 end-0 m-2" data-tippy-content="Overview" title="Overview">
